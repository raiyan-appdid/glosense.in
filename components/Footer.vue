            ...
            <div class="sm:flex sm:flex-wrap sm:-mx-4 md:py-4">
                ...
                <div class="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto">
                    ...
                    <div class="flex sm:justify-center xl:justify-start gap-2">
                        <a target="_blank" href="https://www.facebook.com/profile.php?id=100089037556110&mibextid=LQQJ4d">
                        ...
                        <a target="_blank" href="https://instagram.com/glosense_?igshid=YTQwZjQ0NmI0OA==">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
                                <g fill="none">
