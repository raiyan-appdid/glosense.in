...
<template>
  ...
  <div>
    ...
    <div
      id="sidebar"
      class="sidebar fixed top-6 w-full flex justify-between sm:py-8 sm:px-20 py-5 px-10 z-10"
    ...
    >
      ...
      >
        ...
        <p class="ms-5 text-sm font-semibold text-secondary">
          <span class="hidden text-black sm:block">MENU</span>
        </p>
      </div>
      <div class="flex items-center">
        <div class="hidden sm:block">
          ...
          <a v-show="loggedIn" href="/register"
            ><button class="px-4 py-1 rounded-md bg-secondary text-white ml-2">
              Register
            </button></a
          >
        </div>
    ...
    >
      ...
      <div class="py-4 mt-2 overflow-y-auto">
        <ul class="space-y-2 font-medium">
          ...
          <li @click="closeSideBar">
            <a
              href="/product-detail#faq-redirect"
              class="flex ml-9 items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-[#e3694f] group"
            >
              <svg
                class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-neutral-300 group-hover:text-gray-900 dark:group-hover:text-white"
