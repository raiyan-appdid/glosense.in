<template>
    ...
    <div class="Blog Details mt-20 md:mt-24 pb-20 bg-[#efe8df]">
        ...
        <div class="container mx-auto md:px-40 px-4 ">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Discovering Wellness from
                                Within</span>
                        </div>
                    </li>
                </ol>
            ...
            <p class="my-10 md:text-xl">To tap into wellness from within, it's time to unlock your inner superhero. Your
            ...
            <p class="my-10 md:text-xl">Wellness is all about giving your mind and body some serious love. We get it; it's a
                delicate dance, and you need a bit of both. While we don't want to bombard you with product promotions, it's
                important to know that our products are like those quiet cheerleaders on the sidelines, subtly cheering you
                on in your quest for mental and physical wellness.
            </p>
            <p class="my-10 md:text-xl">The wellness path is all about balance – the delicate equilibrium between self-care
                and seeking a little outside help. We're all in on this equilibrium, and we're committed to providing you
            ...
            <p class="my-10 md:text-xl">Wellness from within is a personal, soul-nourishing journey. We hope this blog post
                has lit a little spark of inspiration in your heart to explore your path to a radiant life. Remember, this
                journey is an ongoing story, and we invite you to discover our products as friendly companions on this
                beautiful voyage.
            </p>
            <p class="my-10 md:text-xl">To learn more about our products and how they can subtly be your wellness allies,
                take a leisurely stroll through our website. Explore our offerings at your own pace and see how they might
                harmonise with your unique path to wellness.
            </p>
        </div>
