...
onMounted(() => {
  ...
  section += 1;
  tlShowcase1.to("#showcase-slider", {
    duration: 5,
    "--fill-till": "+=34",
  });
  tlShowcase1.to(
        ...
        <div class="min-h-screen pt-16 relative border-blue-500 grid grid-cols-12 gap-4">
          <div class="col-span-8">
            <p class="text-secondary text-justify text-xl p-3 font-semibold">
              ...
              confidence related to hair concerns. Your hair is a vital part of
              your presentation and personality, and Hair-You-Glo ensures you
              radiate self-assurance in every interaction. Introducing our
              expertly crafted hair health betterment product, carefully with a
              blend of nature's finest ingredients such as Sea buckthorn
              extract, Carrot, Amla, Lemon, Orange, Tomato fruit, Pomegranate
              extract, Grape seed, Fenugreek seeds extract and more.
            </p>
            <br />

            <p class="text-secondary text-justify text-xl p-3 font-semibold">
              Hair-You-Glo is a product formulated in such a way that helps you
              improve your hair health by containing much required nutrients &
              vitamins in it. Experience the power of nature in every element of
              Hair-You-Glo. Elevate your hair health with a blend of carefully
              selected natural ingredients. Make Hair-You-Glo your daily partner
              in nurturing your hair's vitality. Unlock the secret to radiant,
              confident hair.
            </p>
          </div>
