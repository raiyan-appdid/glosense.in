...
const facebookPixelCode = `
    ...
    fbq('init', '1432488057327276');
    fbq('track', 'PageView');
`;

const noscriptCode = `
    <img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1432488057327276&ev=PageView&noscript=1"
    />
`;
  ...
  <div class="hidden sm:block">
    ...
    <div
      ...
      <div id="hero-section"
        ...
        <div class="home-text flex absolute top-[100px] items-center flex-col w-screen h-screen justify-center"
