...
<template>
    ...
    <div class="product-details px-6 md:px-8  mt-24 pt-4 sm:mt-24 pb-0 bg-white">
                        ...
                        <div class="border-2 border-dashed border-secondary grid grid-cols-12 p-3 mt-3">
                            <div class="col-span-6 flex"><span class="inline-block mr-2"><svg width="20" height="24"
                                        ...
                                        <path class="wuw-bag-icon"
                                            ...
                                            fill="#43a190"></path>
                                    </svg></span><span class="my-auto text-secondary sm:text-lg font-semibold text-sm">Get
                                    it for ₹<span class="font-extrabold">970</span></span>
                            </div>
