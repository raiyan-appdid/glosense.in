...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-us-dummpy-d5088acf.js").then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-60fccffc.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/billing-details-dad7a151.js").then((m) => m.default || m)
  },
  {
    name: "blogs",
    path: "/blogs",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blogs-a0fc4250.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-acba20e8.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-75a5d4fd.js").then((m) => m.default || m)
  },
  {
    name: "logout",
    path: "/logout",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/logout-bece9ef1.js").then((m) => m.default || m)
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy-policy-c5bb0a2b.js").then((m) => m.default || m)
  },
  {
    name: "product-detail",
    path: "/product-detail",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-detail-eb36f873.js").then((m) => m.default || m)
  },
  {
    name: "product-review",
    path: "/product-review",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-review-2f0b0b5b.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/register-c6ea0c33.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-2b02464b.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-96c0c92b.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-c830f47c.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
